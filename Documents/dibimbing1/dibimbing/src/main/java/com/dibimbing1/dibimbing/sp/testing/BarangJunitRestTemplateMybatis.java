package com.dibimbing1.dibimbing.sp.testing;
...
public class BarangJunitRestTemplateMybatis {
    ...
    public void listSukses() {
        ...
        ResponseEntity<String> exchange = restTemplate.exchange("http://localhost:9090/api/v1/sp/barang/list?nama=nama", HttpMethod.GET, null, String.class);
